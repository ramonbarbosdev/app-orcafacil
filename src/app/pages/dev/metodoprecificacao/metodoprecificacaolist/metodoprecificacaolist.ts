...
import { Metodoprecificacaoform } from "../metodoprecificacaoform/metodoprecificacaoform";
@Component({
  selector: 'app-metodoprecificacaolist',
  imports: [TableModule,
    IconFieldModule,
    InputIconModule,
    InputTextModule,
    ButtonModule,
    HeaderListGenerico, Metodoprecificacaoform],
  templateUrl: './metodoprecificacaolist.html',
  styleUrl: './metodoprecificacaolist.scss',
})
export class Metodoprecificacaolist {
 loading: boolean = true;
  ...
  columns: ColumnConfig[] = [
    {
      field: 'cdMetodoPrecificacao',
      header: 'Código',
      minWidth: '10rem',
      filterType: 'text',
    },
    {
      field: 'nmMetodoPrecificacao',
      header: 'Nome',
      minWidth: '15rem',
      filterType: 'text',
    },
