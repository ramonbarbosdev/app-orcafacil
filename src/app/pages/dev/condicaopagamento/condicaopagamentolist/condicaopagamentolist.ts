...
import { Condicaopagamentoform } from "../condicaopagamentoform/condicaopagamentoform";

@Component({
  selector: 'app-condicaopagamentolist',
  imports: [TableModule,
    IconFieldModule,
    InputIconModule,
    InputTextModule,
    ButtonModule,
    HeaderListGenerico, Condicaopagamentoform],
  templateUrl: './condicaopagamentolist.html',
  styleUrl: './condicaopagamentolist.scss',
})
export class Condicaopagamentolist {
  ...
  columns: ColumnConfig[] = [
    {
      field: 'cdCondicaoPagamento',
      header: 'Código',
      minWidth: '10rem',
      filterType: 'text',
    },
    {
      field: 'nmCondicaoPagamento',
      header: 'Nome',
      minWidth: '15rem',
      filterType: 'text',
    },
